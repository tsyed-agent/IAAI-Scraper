...
How-to (short): [`docs/project-tracker.md`](docs/project-tracker.md)
...
Plans (acceptance detail): `docs/09-…`, `docs/10-…`, `docs/handoffs/`.
...
Code is on `main` (PRs #6/#7 merged). Prefer small task branches off `main`.
